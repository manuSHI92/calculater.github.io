...
let SpecialEventsComponent = class SpecialEventsComponent {
    constructor(_Speceventservice, _router) {
    ...
    ngOnInit() {
        this._Speceventservice.getapecislEvent()
            .subscribe(res => this.specialEvent = res, err => {
...
SpecialEventsComponent.ctorParameters = () => [
    { type: _event_service__WEBPACK_IMPORTED_MODULE_2__["EventService"] },
